...
ggplot() + 
  ...
  scale_color_manual(name = "Year", values = c("Montana_1999" = "steelblue", "Maine_2021" = "coral2"))+geom_point(aes(x='Jun',y=70976),colour="coral2")+geom_point(aes(x='Nov',y=70074),colour="steelblue")+ ggtitle("Plot of Transporation_via_object by Month")

```

In order to validate our hypothesis, we conducted an examination of Bus Passengers transportation across states, revealing six outliers in the scatter plot. These outliers are as follows:
