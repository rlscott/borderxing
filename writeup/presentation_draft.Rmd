...
```{r tscompare,fig.align='center', out.width="50%",out.height=240,echo=F, message=F, warning= F}
year <- 0
start_date <- as.Date(paste(year, "-01-01", sep = ""))
end_date <- as.Date(paste(year, "-12-31", sep = ""))
dates <- seq(start_date, end_date, by = "month")
...
```{r impact911,fig.align='center',out.width="70%",out.height=240, echo=F, message=F, warning = F}
# 911
