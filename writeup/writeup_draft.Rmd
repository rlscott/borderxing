...
Figure \@ref(fig:aggrigate) shows the value of the Canada border and Mexico border vs time. We utilize the 'additive' method to decompose the population data at the Canada border and Mexico border , dividing it into three components: trend, season, and random parts. Our focus for this project lies in analyzing the seasonal component. We are interested in the seasonal part.
